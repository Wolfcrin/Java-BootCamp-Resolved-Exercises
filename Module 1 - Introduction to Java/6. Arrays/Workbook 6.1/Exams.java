public class Exams {
    public static void main(String[] args) {
        ...
        System.out.println(students[0] + ", you will taje seat 0");
        System.out.println(students[1] + ", you will taje seat 1");
        System.out.println(students[2] + ", you will taje seat 2");
        System.out.println(students[3] + ", you will taje seat 3");
        System.out.println(students[4] + ", you will taje seat 4");
